...
int main(int argc, char** argv)
{
    ...
    **/
     ...
     */
      ...
      des_position  =  {{-0.688, 0.719, -0.0546, -1.0224, 0.0942, 1.355, -1.885}};
      ...
      des_position  =  {{0.643, 0.837, -0.0615, -0.777, -0.032, 1.533, -0.840}};
      ...
      des_position  =  {{0.166, 0.257, -0.154, -1.499, 0.024, 1.308, -1.55}};
